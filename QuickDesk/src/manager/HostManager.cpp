...
{
    // Note: Currently client_id is a UUID generated by Chromium, not the actual device_id
    // The client's real device_id is not transmitted through signaling protocol yet
    // TODO: Implement device_id transmission in signaling protocol (Phase 2)
    // For now, return a friendly label
    if (m_clients.contains(clientId)) {
